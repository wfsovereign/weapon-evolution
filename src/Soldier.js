...
Soldier.prototype.get_string_of_be_attacked_process_as_attacker = function (attacker) {
    var weapon_random_value = parseInt(Math.random() * 10) / 10;
    return this.get_string_of_attack_process(weapon_random_value, attacker)
};
